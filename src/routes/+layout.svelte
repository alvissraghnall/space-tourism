...
<div
	...
	style="--pageName: url('/background-{pageName}-tablet.jpg');"
>
		...
		>
			...
			>
				<NavLink active={$page.url.pathname === '/'}
					><a href="/"><span class="mr-2">00</span>Home</a></NavLink
				>
				<NavLink active={$page.url.pathname === '/destination'}
					><a href="/destination"><span class="mr-2">01</span>Destination</a></NavLink
				>
				<NavLink active={$page.url.pathname === '/crew'}
					><a href="/crew"><span class="mr-2">02</span>crew</a></NavLink
				>
				<NavLink active={$page.url.pathname === '/technology'}
					><a href="/technology"><span class="mr-2">03</span>technology</a></NavLink
				>
			</ul>
		</div>
...
<style>
	...
	@media (min-width: 768px) {
		.hold {
			background-image: var(--pageName)-tablet;
		}
	}

	@media (min-width: 1024px) {
		.hold {
			background-image: var(--pageName)-desktop;
		}
	}
</style>
